 ...
 * @LastEditTime: 2021-10-07 21:43:00
 * @Description:
 */
    ...
    return (
        <div className="button-list">
            <div onMouseOver={() => toggleToolTip(true, 0)}
                ...
                <ToolTip msg={msg[0]} show={show[0]} posi={posi[0]} />
            ...
            <div onMouseOver={() => toggleToolTip(true, 1)}
                ...
                <ToolTip msg={msg[1]} show={show[1]} posi={posi[1]} />
            ...
            <div onMouseOver={() => toggleToolTip(true, 2)}
                ...
                <ToolTip msg={msg[2]} show={show[2]} posi={posi[2]} />
